...
const _abi = [
  ...
  {
    type: "function",
    name: "isOperatorBtcKeyRegistered",
    inputs: [
      {
        name: "operator",
        type: "address",
  ...
  {
    type: "event",
    name: "OperatorBtckeyDeregistered",
    inputs: [
      {
        name: "operator",
        type: "address",
...
export class BitDSMRegistry__factory {
  static readonly abi = _abi;
  static createInterface(): BitDSMRegistryInterface {
    return new Interface(_abi) as BitDSMRegistryInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): BitDSMRegistry {
    return new Contract(address, _abi, runner) as unknown as BitDSMRegistry;
  }
}
