...
contract BitcoinUtilsTest is Test {
    ...
    function testConvertBits() public pure {
        ...
        bytes memory expected4 =
            hex"150c1c0e130a090e030f0d0b1a160d1b08020a1f0d1805010d1e0f011d050e07030d03140c1714061e12000a100302130d000910";
    ...
    function testCreateChecksum() public pure {
        ...
        bytes memory hrp = "tb";
        bytes memory data =
            hex"00150c1c0e130a090e030f0d0b1a160d1b08020a1f0d1805010d1e0f011d050e07030d03140c1714061e12000a100302130d000910"; // Example data
    ...
    function testConvertScriptPubKeyToBech32Address() public pure {
        ...
        bytes memory script =
            hex"522103cb23542f698ed1e617a623429b585d98fb91e44839949db4126b2a0d5a7320b02103809fa6d4203620e2532d27d482082de8ec866845124038c38bb02e2229dc6cdb52ae";
    ...
    function compareStringsAssemblyHelper(string memory s1, string memory s2) public pure returns (bool) {
        ...
        assembly {
            ...
            if iszero(eq(len1, len2)) { result := 0 }
    ...
    //     emit BitcoinUtils.PSBTVerificationSuccess();
    //     BitcoinUtils.extractVoutFromPSBT(psbt);
    // }
}
