...
import {ECDSAStakeRegistryStorage, Quorum, StrategyParams} from "@eigenlayer-middleware/src/unaudited//ECDSAStakeRegistryStorage.sol";
...
import {CheckpointsUpgradeable} from "@eigenlayer-middleware/lib/openzeppelin-contracts-upgradeable/contracts/utils/CheckpointsUpgradeable.sol";
import {SignatureCheckerUpgradeable} from "@openzeppelin/contracts-upgradeable/utils/cryptography/SignatureCheckerUpgradeable.sol";
import {IERC1271Upgradeable} from "@openzeppelin/contracts-upgradeable/interfaces/IERC1271Upgradeable.sol";

/// @title ECDSA Stake Registry
/// @dev THIS CONTRACT IS NOT AUDITED. The code is taken from eigenlayer-middleware repository tagged # v0.2.1. 
/// @dev This contract is reproduced here to make the contract Inheritable for operator register and deregister functions. 
/// @notice Manages operator registration and quorum updates for an AVS using ECDSA signatures.
// 
abstract contract ECDSAStakeRegistry is 
    OwnableUpgradeable,
    IERC1271Upgradeable,
    ECDSAStakeRegistryStorage
{
    ...
    function registerOperatorWithSignature() virtual external {}
