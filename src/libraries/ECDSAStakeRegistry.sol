...
import {CheckpointsUpgradeable} from
    "@eigenlayer-middleware/lib/openzeppelin-contracts-upgradeable/contracts/utils/CheckpointsUpgradeable.sol";
...
//
abstract contract ECDSAStakeRegistry is OwnableUpgradeable, IERC1271Upgradeable, ECDSAStakeRegistryStorage {
